...
public class ReadButton {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //loop to print ONLY when button state changes
        ...
        while (true) {
            ...
            if (currentState != lastState) {      // Only print on change
                System.out.println("Button State: " + currentState);
                lastState = currentState;
            }
            
//deleted sleep because when you're an elite computer scientist like sam, you don't need sleep
        }
    }
}